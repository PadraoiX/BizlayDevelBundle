...
class ListDatabasesCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('sansis:reverse:listdatabases')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $dbs = $service->getDatabases();

        $msg = "    Databases disponiveis (" . count($dbs) . "): ";
